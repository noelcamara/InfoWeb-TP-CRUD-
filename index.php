<?php
    ...
    switch ($_SESSION['état']) {
        case 'Accueil':
            $contenu = "<figure class='image'><img src='images/accueilBasket.png' alt='Championnat du monde de basketball 2019'
                title='Championnat du monde de basketball 2019'/></figure></div>";
            break;
