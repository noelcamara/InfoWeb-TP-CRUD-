...
INSERT INTO Equipe(nom_equipe, nb_victoire, nb_defaite, nb_points) VALUES
    ...
    ('Venezuela', 2, 3, 7),
    ('Porto Rico', 2, 3, 7),
    ('Republique Dominicaine', 2, 3, 7),
    ('Nigeria', 3, 2, 8),
    ('Allemagne', 3, 2, 8),
    ('Nouvelle-Zelande', 4, 1, 9),
    ('Tunisie', 3, 2, 8),
    ('Canada', 2, 3, 7),
    ('Turquie', 2, 3, 7),
    ('Iran', 2, 3, 7),
...
INSERT INTO Joueur(prenom_joueur, nom_joueur, poste_joueur, capitaine, id_equipe) VALUES
    ...
    ('Dellavedova', 'Matthew', 'Arriere', 'Non', 4),
    ...
    ('Bogdanovic', 'Bogdan', 'Arriere', 'Non', 5),
    ...
    ('Smart', 'Marcus', 'Arriere', 'Non', 7),
    ('Tatum', 'Jayson', 'Ailier', 'Non', 7),
    ('Walker', 'Kemba', 'Arriere', 'Non', 7),

    -- Pologne
    ('Ponitka', 'Mateusz', 'Meneur', 'Non', 8),
    ('Waczynski', 'Adam', 'Ailier', 'Non', 8),
    ('Slaughter', 'Aaron', 'Arriere', 'Non', 8),
    ('Kulig', 'Damian', 'Arriere', 'Non', 8),
    ...
    ('Gruszecki', 'Karol', 'Arriere', 'Non', 8),
    ('Cel', 'Aaron', 'Arriere', 'Non', 8),

    -- Lituanie
    ('Mantas', 'Kalnietis', 'Arriere', 'Oui', 9),
    ...
    -- Grece
    ('Giannoulis', 'Larentzakis', 'Arriere', 'Non', 11),
    ...
    ('Didi', 'Louzada', 'Arriere', 'Non', 13),
    ('Bruno', 'Caboclo', 'Ailier', 'Non', 13),

    -- Venezuela
    ('Gregory', 'Vargas', 'Meneur', 'Oui', 14),
    ('Jhornan', 'Zamora', 'Arriere', 'Non', 14),
    ('Pedro', 'Chourio', 'Arriere', 'Non', 14),
    ...
    ('Gary', 'Browne', 'Arriere', 'Non', 15),
    ('Jorge Bryan', 'Diaz', 'Pivot', 'Non', 15),
    ('Angel', 'Rodriguez', 'Meneur', 'Non', 15),
    ('Gian', 'Clavell', 'Arriere', 'Non', 15),
    ('David', 'Huertas', 'Arriere', 'Oui', 15),
    ('Renaldo', 'Balkman', 'Ailier fort', 'Non', 15),
    ('Alexander', 'Franklin', 'Ailier', 'Non', 15),
    ('Christopher', 'Brady', 'Pivot', 'Non', 15),
    ('Javier', 'Mojica', 'Arriere', 'Non', 15),

    -- Republique Dominicaine
    ('Dagoberto', 'Pena', 'Arriere', 'Non', 16),
    ('Rigoberto', 'Mendoza', 'Arriere', 'Non', 16),
    ('Victor', 'Liz', 'Arriere', 'Non', 16),
    ...
    ('Luis', 'Montero', 'Arriere', 'Non', 16),

    -- Nigeria
    ('Ike', 'Iroegbu', 'Meneur', 'Non', 17),
    ('Ben', 'Uzoh', 'Meneur', 'Non', 17),
    ('Stan', 'Okoye', 'Arriere', 'Non', 17),
    ...
    ('Josh', 'Okogie', 'Arriere', 'Non', 17),
    ('Nnamdi', 'Vincent', 'Arriere', 'Non', 17),
    ...
    ('Melih', 'Mahmutoglu', 'Arriere', 'Non', 22),
    ('Ege', 'Arar', 'Ailier fort', 'Non', 22),
    ('Bugrahan', 'Tuncer', 'Arriere', 'Oui', 22),
    ('Sertac', 'Sanli', 'Pivot', 'Non', 22),
    ('Furkan', 'Forkmaz', 'Arriere', 'Non', 22),
    ('Yigit', 'Arslan', 'Arriere', 'Non', 22),

    -- Iran
    ('Rasoul', 'Mozafarivanani', 'Arriere', 'Non', 23),
    ...
    ('Behnam', 'Yakhchalidehkordi', 'Arriere', 'Non', 23),
    ('Arman', 'Zangeneh', 'Ailier fort', 'Non', 23),
    ('Mohammad', 'Jamshidijafarabadi', 'Arriere', 'Non', 23),
    ...
    ('Petar', 'Popovic', 'Arriere', 'Non', 25),
    ('Milko', 'Bjelica', 'Ailier fort', 'Non', 25),

    -- Coree
    ('Chan Heee', 'Park', 'Arriere', 'Non', 26),
    ('Junyong', 'Choi', 'Ailier', 'Non', 26),
    ('Junghyun', 'Lee', 'Arriere', 'Non', 26),
    ('Sunhyung', 'Kim', 'Arriere', 'Non', 26),
    ('Hoon', 'Heo', 'Arriere', 'Non', 26),
    ...
    ('Daesung', 'Lee', 'Arriere', 'Non', 26),

    -- Angola
    ('Gerson', 'Domingos', 'Arriere', 'Non', 27),
    ('Yanick', 'Moeira', 'Pivot', 'Oui', 27),
    ('Jerson', 'Goncalves', 'Arriere', 'Non', 27),
    ('Olimpio', 'Cipriano', 'Arriere', 'Non', 27),
    ('Carlos', 'Morais', 'Arriere', 'Non', 27),
    ...
    ('Valdelicio', 'Joaquim', 'Pivot', 'Non', 27),
    ('Jaques', 'Conceicao', 'Arriere', 'Non', 27),

    -- Jordanie
    ('Mahmoud', 'Abdeen', 'Meneur', 'Non', 28),
    ('Amin', 'Abu Hawwas', 'Arriere', 'Non', 28),
    ('Dar', 'Tucker', 'Arriere', 'Non', 28),
    ('Jordan', 'Al-Dasuqi', 'Meneur', 'Non', 28),
    ('Freddy', 'Ibrahim', 'Arriere', 'Non', 28),
    ...
    ('Mousa', 'Alawadi', 'Arriere', 'Oui', 28),
    ('Ahmad', 'Al Dwairi', 'Pivot', 'Non', 28),

    -- Cote d''Ivoire
    ('Charles', 'Abouo', 'Arriere', 'Non', 29),
    ...
    ('Xane', 'Dalmeida', 'Arriere', 'Non', 30),
    ('Pape', 'Diop', 'Ailier', 'Oui', 30),
    ('Lamine', 'Sambe', 'Arriere', 'Non', 30),
    ...
    ('Roger', 'Pogoy', 'Arriere', 'Non', 32),
    ('Jaymar', 'Perez', 'Arriere', 'Non', 32),
